...
import { Facebook, Instagram, Mail, MapPin, Phone, Globe, Twitter, Youtube } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          >
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-4">
              {settings?.site_name || t("nameweb")}
            </h3>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              {settings?.tagline || t("prompt")}
            </p>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-[#468e83]/20 dark:border-gray-800">
          <div className="text-gray-600 dark:text-gray-400 mb-4 md:mb-0">
            © {currentYear} {settings?.site_name || "YEUNG THOTT"}. {t("allRightsReserved")}
          </div>
