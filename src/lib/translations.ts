...
export const translations: Translations = {
  en: {
    ...
    member1Desc: "Uth David is a passionate professional with expertise in photography and color grading. His dedication to creativity and precision allows him to deliver exceptional visual results. With a strong eye for detail, he plays a key role in producing high-quality, innovative work. And his commitment to excellence is evident in every project.",
  ...
  km: {
    ...
    member1Desc: "អ៊ុត ដាវីត គឺជាអ្នកជំនាញមានចិត្តស្មោះត្រង់ក្នុងវិស័យថតរូប និងការកែពណ៌។ ការខិតខំរបស់គាត់ក្នុងការច្នៃប្រឌិត និងភាពត្រឹមត្រូវអនុញ្ញាតឱ្យគាត់ផ្តល់លទ្ធផលវិចិត្រសិល្ប៍ល្អឥតខ្ចោះ។ មានការយល់ឃើញច្បាស់ពីលម្អិត គាត់មានតួនាទីសំខាន់ក្នុងការផ្តល់ការងារដែលមានគុណភាពខ្ពស់ និងច្នៃប្រឌិត។ ហើយផ្តោតលើការស្វែងរក នូវវិធីសាស្រ្តថ្មីៗ និងការលូតលាស់ក្នុងវិស័យនេះ។",
